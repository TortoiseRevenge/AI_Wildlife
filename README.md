...
&ensp;&ensp;&ensp;    1. An Azure Account with general setup<br>
...
Going back to the logic app, you should now create a new action, specifiaclly an "Azure Function". There, you'll want to add a new parameter called "body". In there, input the following things:
```
{
...
```
Make sure to Input your keys for the keys as listed above. If you want to change the text response, change the text category.
